...
from shared.utils.ai.prompts.fallback import FALLBACK_SYSTEM_PROMPT, build_fallback_prompt
from shared.models.test_plan import Action
from shared.models.test_result import FallbackRecord
...
class FallbackHandler:
    ...
    def request_fallback(
        ...
        user_message = build_fallback_prompt(
            ...
            original_action_json=json.dumps(original_action.model_dump(), default=str),
        )
        ...
        try:
            ...
            try:
                if hasattr(AIClient, "_save_parse_failure"):
                    AIClient._save_parse_failure(
                        call_number=getattr(self.ai_client, "call_count", 0),
